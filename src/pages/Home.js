                ...
                >
                    ...
                    <div className="relative z-10 text-center">
                        ...
                        <p className="text-xl mb-8">
                            Discover the best products with unmatched quality and service.
                        </p>
                        <Link
                            to="/signup"
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {testimonials.map((testimonial, index) => (
                        <div key={index} className="p-8 bg-gray-800 rounded-lg shadow-lg">
                            <img src={testimonial.image} alt={testimonial.customer} className="w-16 h-16 rounded-full mx-auto mb-4" />
                            <p className="text-gray-400 mb-4 text-start">"{testimonial.quote}"</p>
                            <h3 className="text-xl font-bold">{testimonial.customer}</h3>
